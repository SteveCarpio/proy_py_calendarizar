...
def pasoHelp():
    ...
    print("")
    print(Fore.WHITE   + "          C:\\MisCompilados\\PROY_CALENDARIZAR\\BBDD\\                  *** BBDD Raíz del programa en el servidor Python  ")        
    print(Fore.WHITE   + "          C:\\MisCompilados\\PROY_CALENDARIZAR\\CONFIG\\                *** CONFIG Raíz del programa en el servidor Python   ")
    ...
    print(Fore.WHITE   + "          \\newton\\comun$\\Proyectos\\Python\\MisCompilados\\PROY_CALENDARIZAR  *** Ruta de Red ")
    print("")
    ...
    print(Fore.WHITE   + "          destinatarios.csv - Lista de email de envió ")
    print("")
